...
static const CGEN_IBASE nios_cgen_macro_insn_table[] = {
	/* if0 $m16_Ra,$i5 */
	{
		-1, "if016", "if0", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* if1 $m16_Ra,$i5 */
	{
		-1, "if116", "if1", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* ifrz $m16_Ra */
	{
		-1, "ifrz16", "ifrz", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* ifrnz $m16_Ra */
	{
		-1, "ifrnz16", "ifrnz", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* ifs $i4wn */
	{
		-1, "ifs16", "ifs", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* nop */
	{
		-1, "nop16", "nop", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* inc $m16_Ra */
	{
		-1, "inc16", "inc", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* dec $m16_Ra */
	{
		-1, "dec16", "dec", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* clr $m16_Ra */
	{
		-1, "clr16", "clr", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* ret */
	{
		-1, "ret16", "ret", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* lret */
	{
		-1, "lret16", "lret", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS16) } } } } },
	/* if0 $m32_Ra,$i5 */
	{
		-1, "if032", "if0", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* if1 $m32_Ra,$i5 */
	{
		-1, "if132", "if1", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* ifrz $m32_Ra */
	{
		-1, "ifrz32", "ifrz", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* ifrnz $m32_Ra */
	{
		-1, "ifrnz32", "ifrnz", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* ifs $i4wn */
	{
		-1, "ifs32", "ifs", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* nop */
	{
		-1, "nop32", "nop", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* inc $m32_Ra */
	{
		-1, "inc32", "inc", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* dec $m32_Ra */
	{
		-1, "dec32", "dec", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* clr $m32_Ra */
	{
		-1, "clr32", "clr", 16, { 0 | A (NO_DIS) | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* ret */
	{
		-1, "ret32", "ret", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
	/* lret */
	{
		-1, "lret32", "lret", 16, { 0 | A (ALIAS), { { { (1 << MACH_NIOS32) } } } } },
};
...
void nios_cgen_init_opcode_table(CGEN_CPU_DESC cd) {
	int i;
